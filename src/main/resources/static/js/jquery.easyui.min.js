...
(function($) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _a55,
        rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _9cb(true), mouseout: _9cb(false), click: _9cd }),
        ...
        $(_aa2).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [
                [{
                    ...
                    width: "100%",
                    formatter: function(_aa3, row, _aa4) {
